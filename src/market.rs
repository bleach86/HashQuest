...
impl MiningRig {
    ...
    pub fn get_rug_protection_amount(&self) -> f32 {
        ...
        match self.rug_protection.level {
            ...
            4..=6 => 0.15 + ((self.rug_protection.level - 4) as f32 * 0.03),
            7..=9 => 0.20 + ((self.rug_protection.level - 7) as f32 * 0.05),
            10..=12 => 0.25 + ((self.rug_protection.level - 10) as f32 * 0.08),
            13..=15 => 0.30 + ((self.rug_protection.level - 13) as f32 * 0.10),
            16..=18 => 0.35 + ((self.rug_protection.level - 16) as f32 * 0.12),
            19..=21 => 0.40 + ((self.rug_protection.level - 19) as f32 * 0.15),
            22..=24 => 0.45 + ((self.rug_protection.level - 22) as f32 * 0.18),
            25..=27 => 0.50 + ((self.rug_protection.level - 25) as f32 * 0.20),
            28..=30 => 0.55 + ((self.rug_protection.level - 28) as f32 * 0.22),
            31..=33 => 0.60 + ((self.rug_protection.level - 31) as f32 * 0.25),
            34..=36 => 0.65 + ((self.rug_protection.level - 34) as f32 * 0.28),
            37..=40 => 0.70 + ((self.rug_protection.level - 37) as f32 * 0.30),
            41..=45 => 0.75 + ((self.rug_protection.level - 41) as f32 * 0.32),
            46..=50 => 0.80 + ((self.rug_protection.level - 46) as f32 * 0.35),
            51..=55 => 0.85 + ((self.rug_protection.level - 51) as f32 * 0.38),
            56..=60 => 0.90 + ((self.rug_protection.level - 56) as f32 * 0.40),
            61..=64 => 0.95 + ((self.rug_protection.level - 61) as f32 * 0.42),
            _ => 1.0,
        }
    }
